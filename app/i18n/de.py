"""German strings — the bot's original language.

Keys mirror the old app/texts.py constants 1:1, plus the button/label
literals absorbed from app/keyboards.py and app/formatting.py, plus command
descriptions and the /language UI. See app/i18n/en.py for the English
counterpart — tests/test_i18n.py keeps the two in sync.
"""
...
STRINGS: dict[str, str] = {
    ...
    "HELP": (
        ...
        "/sprache – Sprache wechseln (Deutsch/English)\n"
    ...
    "ASK_NUMBER_ROOMS_MIN": "Wie viele Zimmer *mindestens*? Schick mir eine Zahl, z. B. `2` oder `2,5`.",
    "ASK_NUMBER_ROOMS_MAX": "Wie viele Zimmer *höchstens*? Schick mir eine Zahl, z. B. `3,5`.",
    "ASK_NUMBER_MAX_RENT": "Wie hoch darf die *Gesamtmiete* höchstens sein? Zahl in Euro, z. B. `1250`.",
    "ASK_NUMBER_MIN_SIZE": "Wie viel *Wohnfläche* mindestens? Zahl in m², z. B. `60`.",
    ...
    "WBS_OPT_NO": "nur ohne WBS",
    "WBS_OPT_YES": "nur mit WBS",
    "SELECT_ALL": "Alle auswählen",
    "ACTIVATE_ALARMS": "Alarme aktivieren",
    "EDIT_AGAIN": "Nochmal bearbeiten",
    "SETUP_FILTER": "Filter einrichten",
    "JUST_LOOKING": "Erstmal nur gucken",
    "CONFIRM_DELETE_YES": "Ja, alles löschen",
    "CANCEL": "Abbrechen",
    "RESET_FILTER": "Filter zurücksetzen",
    "DONE": "Fertig",
    "ROOT_ROOMS_MIN": "Zimmer ab: {value}",
    "ROOT_ROOMS_MAX": "Zimmer bis: {value}",
    "ROOT_RENT": "Miete: {value}",
    "ROOT_SIZE": "Größe: {value}",
    "ROOT_WBS": "WBS: {value}",
    "ROOT_DISTRICTS": "Bezirke: {value}",
    "ROOT_PROVIDERS": "Anbieter: {value}",

    # -- match message + filter labels (app/formatting.py) -------------------
    "WBS_REQUIRED": "erforderlich",
    "WBS_NOT_REQUIRED": "nicht erforderlich",
    "MATCH_RENT_LABEL": "Miete: ",
    "MATCH_SIZE_LABEL": "Fläche: ",
    "MATCH_ROOMS_LABEL": "Zimmer: ",
    "MATCH_WBS_LABEL": "WBS: ",
    "MATCH_PROVIDER_LABEL": "Anbieter: ",
    "MATCH_LINK_LABEL": "Zur original Anzeige",
    "LABEL_ROOMS_FROM": "ab {value}",
    "LABEL_ROOMS_TO": "bis {value}",
    "LABEL_ROOMS_RANGE": "{lo}–{hi}",
    "LABEL_RENT_MAX": "max. {value} €",
    "LABEL_SIZE_MIN": "ab {value} m²",
    "LABEL_ALL": "alle",
    "LABEL_SELECTED_N": "{n} ausgewählt",
    "LABEL_NO_RESTRICTION": "keine Einschränkung",
    "LABEL_WITH_WBS": "mit WBS",
    "LABEL_WITHOUT_WBS": "ohne WBS",
    "UNIT_ROOMS_SUFFIX": "Zi",
    "UNIT_DISTRICT_SINGULAR": "Bezirk",
    "UNIT_DISTRICT_PLURAL": "Bezirke",
    "UNIT_PROVIDER_SINGULAR": "Anbieter",
    "UNIT_PROVIDER_PLURAL": "Anbieter",
    "MONEY_FORMAT": "{amount} €",

    # -- command descriptions (BotFather menu) --------------------------------
    "CMD_DESC_START": "Einführung und Einrichtung",
    "CMD_DESC_FILTER": "Suche ändern",
    "CMD_DESC_STATUS": "Filter und Statistik",
    "CMD_DESC_PAUSE": "Benachrichtigungen aussetzen",
    "CMD_DESC_RESUME": "Benachrichtigungen fortsetzen",
    "CMD_DESC_PROBLEM": "Problem melden",
    "CMD_DESC_STOP": "Alle Daten löschen",
    "CMD_DESC_HELP": "Übersicht aller Befehle",
    "CMD_DESC_LANGUAGE": "Sprache wechseln",

    # -- /language UI ---------------------------------------------------------
    "LANGUAGE_PROMPT": "In welcher Sprache?",
